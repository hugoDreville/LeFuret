  ...
  static Future<void> createTables() async {
    ...
    try {
      ...
      try {
        ...
        if (!checkArticle) {
          requete =
              'CREATE TABLE Article (id int NOT NULL AUTO_INCREMENT PRIMARY KEY, titre varchar(250), type varchar(20), quantite int, prix DECIMAL, anneeParution varchar(4), idEditeur int, idAuteur int);';
